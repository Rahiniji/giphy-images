...
### On load of landing page, initial API call is triggered to fetch some trending data limited to 20

### Upon searching with keyword, search API call is triggered and updates the display items accordingly

### Pagination works fine, with default page reset to 1 after searching. On clearing search text field, initial data is repopulated again
